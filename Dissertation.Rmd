...
![(a) 2nd generation neuron. (b) 3rd generation neuron.](images/second_vs_third_gen_neuron.png){#fig:second_vs_third_gen fig-align=center}
...
The highlighted neuron, $h_{1}$, is connected to all input neurons, $x_{1}$, $x_{2}$, and $x_{3}$.  Therefore $h_{1}$ is a weighted sum of all the input neurons (Equation \ref{eqn:weightedsum2}).  
...
Alternate loss function weight, Gaussian window:
$$w(t) = exp(-\frac{(t-\mu)^2}{2\sigma^2})$$
