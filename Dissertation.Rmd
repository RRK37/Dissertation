...
The section marked "Backward Pass" uses the 
...
This is cool, I reached the original project objective of training a SNN to recognise voice
...
Testing the new loss it increases the learning rate 
