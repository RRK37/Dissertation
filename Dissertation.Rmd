...
GRAPHS OF TRAINING 
GRAPHS OF WEIGHTS CHANGING OVER TIME?
...
![Plot of the weightings of the exponential function (blue) and the Gaussian (blue) against -t/T from 0 to 1.](images/plot_bell_vs_exp.png){#fig:exp_vs_bell_plot fig-align=center}
...
\begin{equation}
$$ V_{gausian\_mod}(t) = a( -t/T)  \exp{\left( \frac{( -t/T)^2} {2c^2}\right)}\ V(t) $$
\label{eqn:gaus_sum_simple}}
\end{equation}



![Plot of the weightings of the exponential function (blue) and the Gaussian (blue) against -t/T from 0 to 1.](images/plot_gaus_vs_exp.png){#fig:exp_vs_gaus_plot fig-align=center}
